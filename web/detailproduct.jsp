...
<html lang="en">
    ...
    <head>
        ...
        <style>
            ...
            <%@ include file="./css/detailproduct.css"%>
        </style>
    ...
    <body>
                                ...
                                <div class="col-md-6">
                                    <div class="product p-4">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="d-flex align-items-center"> <i class="fas fa-arrow-left"></i> <span
                                        ...
                                        <div class="cart mt-4 align-items-center">
                                            ...
                                            <button class="btn btn-danger text-uppercase mr-2 px-4">Buy</button>
        ...
        <jsp:include page="footer.jsp"></jsp:include>
            ...
            <%@include file="./js/detailproduct.js"%>
        </script>
    </body>
